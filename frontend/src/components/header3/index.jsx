              ...
              <ul className="main-nav">
                ...
                <li className="has-submenu">
                  ...
                  >
                    ...
                    <li>
                      <Link to="/instructor-course">Mening Kurslarim</Link>
                    </li>
                    <li>
                      <Link to="/instructor-reviews">Mijozlar Fikri</Link>
                    </li>
                    <li>
                      <Link to="/instructor-earnings">Daromad</Link>
                    </li>
                    <li>
                      <Link to="/instructor-orders">Buyurtmalar</Link>
                    </li>
                    <li>
                      <Link to="/instructor-payouts">Pulni yechib olish</Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link to="/instructor-security">Xavfsizlik</Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link to="/instructor-notifications">Xabarlar</Link>
                    </li>
                    <li>
                ...
                <li className="has-submenu">
                  ...
                  >
                    ...
                    <li>
                      <Link to="/setting-student-security">Xavfsizlik</Link>
                    </li>
                    <li>
                ...
                <li className="login-link">
                  <Link to="/login">Kirish / Registratsiya</Link>
                </li>
              </ul>
            </div>
